...
filename <- "/Users/path/to/data/Hydra_Standardized_MaternalEd.xlsx"  # Provide the desired file path
wb <- createWorkbook()
...
Define adjust variable used in lm to minimize script editing
```{r}
adjust = subjData$mom_education_b
```
...
rm(list=setdiff(ls(),c("subjData","n",'filename','wb','adjust')))
...
rnames = bifactors
var = 5 # var = number of variables included in lm model (age, gender, bifactors, site/scanner & adjust)  
...
#TD is the comparison group in Hydra_k2. This model will provide estimates and p-values for TD vs. S1 and TD vs. S2.
biLm <- lapply(bifactors, function(x) {
  lm(substitute(i ~ age_1 + FEMALE_b + Hydra_k2 + mri_info_deviceserialnumber_b + adjust, list(i = as.name(x))), data=subjData)
})
...
#This model will provide estimates and p-values for S1-S2.
biLm_reordered <- lapply(bifactors, function(x) {
  lm(substitute(i ~ age_1 + FEMALE_b + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust, list(i = as.name(x))), data=subjData)
})
...
#TD is the comparison group in Hydra_k2. This model will provide estimates and p-values for TD vs. S1 and TD vs. S2.
biLm <- lapply(bifactors, function(x) {
  lm(substitute(i ~ age_2 + FEMALE_b + Hydra_k2  + mri_info_deviceserialnumber_b + adjust, list(i = as.name(x))), data=subjData)
})
...
#This model will provide estimates and p-values for S1-S2.
biLm_reordered <- lapply(bifactors, function(x) {
  lm(substitute(i ~ age_2 + FEMALE_b + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust, list(i = as.name(x))), data=subjData)
})
...
##Run model
flankerLm <- lm(flanker_b ~ age_b + FEMALE_b + Hydra_k2 + mri_info_deviceserialnumber_b + adjust, data=subjData)
...
##Run same model with Hydra_k2_reordered to make S2 the comparison group in order to see S1 vs S2 differences in the model.
flankerLm_reordered <- lm(flanker_b ~ age_b + FEMALE_b + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust, data=subjData)
...
##Run model
cardLm <- lm(cardsort_b ~ age_b + FEMALE_b + Hydra_k2 + mri_info_deviceserialnumber_b + adjust, data=subjData)
...
##Run same model with Hydra_k2_reordered to make S2 the comparison group in order to see S1 vs S2 differences in the model.
cardLm_reordered <- lm(cardsort_b ~ age_b + FEMALE_b + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust, data=subjData)
...
##Run model
patternLm <- lm(pattern_b ~ age_b + FEMALE_b + Hydra_k2 + mri_info_deviceserialnumber_b + adjust, data=subjData)
...
##Run same model with Hydra_k2_reordered to make S2 the comparison group in order to see S1 vs S2 differences in the model.
patternLm_reordered <- lm(pattern_b ~ age_b + FEMALE_b + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust, data=subjData)
...
#Run model
totGrayLm <- lm(smri_vol_cdk_total_b_1000 ~ age_b + FEMALE_b  + Hydra_k2 + mri_info_deviceserialnumber_b + adjust, data=subjData)
totGrayLmSumm <- summary(totGrayLm)


#Run same model with Hydra_k2_reordered to make S2 the comparison group in order to see S1 vs S2 differences in the model.
totGrayLm2 <- lm(smri_vol_cdk_total_b_1000 ~ age_b + FEMALE_b  + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust, data=subjData)
...
#Run model
icvLm <- lm(TICV_b_1000 ~ age_b + FEMALE_b + Hydra_k2 + mri_info_deviceserialnumber_b + adjust, data=subjData)
icvLmSumm <- summary(icvLm)

#Run same model with Hydra_k2_reordered to make S2 the comparison group in order to see S1 vs S2 differences in the model.
icvLm2 <- lm(TICV_b_1000 ~ age_b + FEMALE_b + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust,  data=subjData)
...
#Run model
icvLm <- lm(smri_thick_cdk_mean_b ~ age_b + FEMALE_b + Hydra_k2 + mri_info_deviceserialnumber_b + adjust, data=subjData)
icvLmSumm <- summary(icvLm)

#Run same model with Hydra_k2_reordered to make S2 the comparison group in order to see S1 vs S2 differences in the model.
icvLm2 <- lm(smri_thick_cdk_mean_b ~ age_b + FEMALE_b + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust,  data=subjData)
icvLmSumm2 <- summary(icvLm2)
...
#write.table(svol_pairwise_signif, file = "/Users/Gabby/Desktop/HYDRA/HYDRA-master/pfdr_pairwise_svol.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
#Save the pairwise results as a .csv file
#write.table(vol_pairwise_signif, file = "/Users/Gabby/Desktop/HYDRA/HYDRA-master/pfdr_pairwise_vol.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
#Run model
totGrayLm <- lm(smri_vol_cdk_total_2_1000 ~ age_2 + FEMALE_b  + Hydra_k2 + mri_info_deviceserialnumber_b + adjust, data=subjData)
totGrayLmSumm <- summary(totGrayLm)


#Run same model with Hydra_k2_reordered to make S2 the comparison group in order to see S1 vs S2 differences in the model.
totGrayLm2 <- lm(smri_vol_cdk_total_2_1000 ~ age_2 + FEMALE_b  + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust, data=subjData)
totGrayLmSumm2 <- summary(totGrayLm2)
...
#Run model
icvLm <- lm(TICV_2_1000 ~ age_2 + FEMALE_b + Hydra_k2 + mri_info_deviceserialnumber_b + adjust, data=subjData)
icvLmSumm <- summary(icvLm)

#Run same model with Hydra_k2_reordered to make S2 the comparison group in order to see S1 vs S2 differences in the model.
icvLm2 <- lm(TICV_2_1000 ~ age_2 + FEMALE_b + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust,  data=subjData)
icvLmSumm2 <- summary(icvLm2)
...
icvLm <- lm(smri_thick_cdk_mean_2 ~ age_2 + FEMALE_b + Hydra_k2 + mri_info_deviceserialnumber_b + adjust, data=subjData)
icvLmSumm <- summary(icvLm)

#Run same model with Hydra_k2_reordered to make S2 the comparison group in order to see S1 vs S2 differences in the model.
icvLm2 <- lm(smri_thick_cdk_mean_2 ~ age_2 + FEMALE_b + Hydra_k2_reordered + mri_info_deviceserialnumber_b + adjust,  data=subjData)
icvLmSumm2 <- summary(icvLm2)
